...
if (isset($_POST["username"])&&isset($_POST["pwd"]))
{
    ...
    $pwd =$_POST["pwd"];
    $user=new UserController('','','','',$username,$pwd);
    $res=$user->verifUser();
  	if($res==1)
   {
                        ...
                        <div class="card-body">
                            <form class="form" role="form"  id="formLogin"  method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg rounded-0" name="username" id="uname1" required="">
                                    <div class="invalid-feedback">Oops, you missed this one.</div>
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" class="form-control form-control-lg rounded-0" id="pwd1" name="pwd" required="" autocomplete="new-password">
                                    <div class="invalid-feedback">Enter your password too!</div>
                                </div>
                                
                                <button type="submit" name="login" style="background-color : #0e8ce4;" class="btn btn-success btn-lg float-right" id="btnLogin">Sign In</button>
                            </form>
                        </div>
                        <!--/card-block-->
                    </div>
