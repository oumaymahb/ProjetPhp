...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="core/assets/lib/stroke-7/style.css"/>
    <link rel="stylesheet" type="text/css" href="core/assets/lib/jquery.nanoscroller/css/nanoscroller.css"/><!--[if lt IE 9]>
    <script src="https://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
    <script src="https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="core/assets/lib/theme-switcher/theme-switcher.min.css"/>
    <link rel="stylesheet" type="text/css" href="core/assets/lib/bootstrap-touchspin/jquery.bootstrap-touchspin.min.css"/><link type="text/css" href="core/assets/css/style.css" rel="stylesheet">  </head>
  <body>
    <div class="am-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div id="am-navbar-collapse" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right am-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="core/assets/img/avatar.jpg"><span class="user-name">Samantha Amaretti</span><span class="angle-down s7-angle-down"></span></a>
                        ...
                        <div class="content nano-content">
                          <ul>
                            <li class="active"><a href="#">
                                <div class="logo"><img src="core/assets/img/avatar2.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="core/assets/img/avatar3.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="core/assets/img/avatar4.jpg"></div>
                            ...
                            <li><a href="#">
                                <div class="logo"><img src="core/assets/img/avatar5.jpg"></div>
                  ...
                  <li>
                    ...
                    <div class="list">
                      <div class="content">
                        <ul>
                          <li>
                            <div class="logo"><img src="core/assets/img/github.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="core/assets/img/bitbucket.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="core/assets/img/slack.png"></div>
                          ...
                          <li>
                            <div class="logo"><img src="core/assets/img/dribbble.png"></div>
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input id="postfix" type="text" value="55" name="postfix" class="form-control">
                      </div>
                    </div>
      ...
      <nav class="am-right-sidebar">
        <div class="sb-content">
          <div class="user-info"><img src="core/assets/img/avatar.jpg"><span class="name">Samantha Amaretti<span class="status"></span></span><span class="position">Art Director</span></div>
            ...
            <div class="tab-content">
              ...
              <div id="tab2" role="tabpanel" class="tab-pane chat">
                  ...
                  <div class="chat-sections">
                    <div class="am-scroller nano">
                      <div class="content nano-content">
                        <h2>Recent</h2>
                        <div class="recent">
                          <div class="user"><a href="#"><img src="core/assets/img/avatar4.jpg">
                              <div class="user-data"><span class="status away"></span><span class="name">Claire Sassu</span><span class="message">Can you share the...</span></div></a></div>
                          <div class="user"><a href="#"><img src="core/assets/img/avatar7.jpg">
                              <div class="user-data"><span class="status"></span><span class="name">Maggie jackson</span><span class="message">I confirmed the info.</span></div></a></div>
                          <div class="user"><a href="#"><img src="core/assets/img/avatar3.jpg">
                              <div class="user-data"><span class="status offline"></span><span class="name">Joel King		</span><span class="message">Ready for the meeti...</span></div></a></div>
                        </div>
                        <h2>Contacts</h2>
                        <div class="contact">
                          <div class="user"><a href="#"><img src="core/assets/img/avatar6.jpg">
                              <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div></a></div>
                          <div class="user"><a href="#"><img src="core/assets/img/avatar7.jpg">
                              <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div></a></div>
                          <div class="user"><a href="#"><img src="core/assets/img/avatar8.jpg">
                ...
                <div class="chat-window">
                  <div class="title">
                    <div class="user"><img src="core/assets/img/avatar7.jpg">
    ...
    <script src="core/assets/lib/jquery/jquery.min.js" type="text/javascript"></script>
    <script src="core/assets/lib/jquery.nanoscroller/javascripts/jquery.nanoscroller.min.js" type="text/javascript"></script>
    <script src="core/assets/js/main.js" type="text/javascript"></script>
    <script src="core/assets/lib/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="core/assets/lib/theme-switcher/theme-switcher.min.js" type="text/javascript"></script>
    <script src="core/assets/lib/bootstrap-touchspin/jquery.bootstrap-touchspin.min.js" type="text/javascript"></script>
