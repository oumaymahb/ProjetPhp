<?php
 ...
 $p=new ProduitController();
       $cateselect=$p->getAllProduit();
        $p=new CategrieController();
        $i=$_GET['id'];
        echo $i;
          $pr=$p->getCategorieById($i);
        
        if (isset($_POST["CategorieName"]))  
        {
    $cat =$_POST["CategorieName"];
    echo 'aaa';
    echo $cat;
            ...
            <div class="col-md-12">
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="ModifierCategorie.php?id=<?=$pr['id_cat']?>" class="form-horizontal group-border-dashed" method="POST" enctype="multipart/form-data">
                     
                   
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Name</label>
                      <div class="col-sm-6">
                        <input type="text" required="yes" placeholder="CategorieName" value="<?php echo $pr['lib_cat']?>" class="form-control" name="CategorieName">
                      </div>
                    </div>
